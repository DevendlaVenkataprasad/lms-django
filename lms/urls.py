...
urlpatterns = [
    ...
    ##
    path('course/<int:course_id>/forum/', course_forum, name='course_forum'),
    path('question/<int:question_id>/answer/', post_answer, name='post_answer'),
    path('vote/<str:type>/<str:obj_type>/<int:obj_id>/', vote_item, name='vote_item'),
